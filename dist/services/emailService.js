...
exports.sendSupportTicketEmail = exports.sendResetCodeEmail = void 0;
...
const sendResetCodeEmail = async (email, code, type = 'reset') => {
...
const sendSupportTicketEmail = async (data) => {
    const { host, port, user, pass } = getSMTPConfig();
    if (!user || !pass) {
